    ...
    <body class="bg-blue-900 h-screen" <?php if ($dark_mode === 'dark') { echo 'style="background-color: black !important; color: white !important;"'; } ?>>
        <div class="flex">
            ...
            <div class="w-2/5 text-white h-12 pl-32 py-4 h-auto leftTest">
              ...
              <nav class="mt-5 px-2">
                <a href="#" class="group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full bg-blue-800 text-blue-300" style="width: 200px">
              <svg class="mr-4 h-6 w-6 " stroke="currentColor" fill="none" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l9-9 9 9M5 10v10a1 1 0 001 1h3a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1h3a1 1 0 001-1V10M9 21h6"/>
              </svg>
              Accueil
            </a>
            <a href="#" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-blue-800 hover:text-blue-300" style="width: 200px">
            ...
            <a href="index.php?action=preferences" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300" style="width: 200px">
            ...
            <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="block text-white " type="button"> 
                <a href="#" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300" style="width: 200px">
            ...
            <div id="popup-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full" style="color:red">
                <div class="relative w-full h-full max-w-md md:h-auto">
                    ...
                    <button class="left-form">X</button>
                        ...
                        <div class="pl-16">
                            <form action="#" >
                            <input type="text">
                            <button style="color:white">entree</button>
                        </form>
                        </div>
                ...
                <a href="index.php?action=profile&id=<?php echo $_SESSION['idUser']; ?>" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300" style="width: 200px">
                ...
                <a  href="logout.php" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300" style="width: 200px">
                ...
                <div class="relative w-full h-full max-w-md md:h-auto">
                    ...
                    <div class="flex">
                        ...
                        <div class="flex-1 px-2 pt-2 mt-2">
                            <textarea class=" bg-transparent text-gray-400 font-medium text-lg w-full textTweet"  name="text" rows="2" cols="50" placeholder="Quoi de neuf ?" maxlength="140"></textarea>
                        </div>                    
                    </div>
            ...
            <div class="w-3/5 border border-gray-600 h-auto  border-t-0 midTest" style="overflow: scroll">
                ...
                <div class="flex">
                    <div class="flex-1 m-2">
                        <h2 class="px-4 py-2 text-xl font-semibold text-white">Accueil</h2>
                    </div>
			...
			<?php if(isset($info))
			{
				...
				{
			?>
           <?php if($info[$i]["parent"] == null)
           {?>

            <div class="tweet-card" data-tweet-id="<?php echo $info[$i][0]; ?>">
                <div class="flex flex-shrink-0 p-4 pb-0">
                    <a href="#" class="flex-shrink-0 group block">
                    <div class="flex items-center">
                        <div>
                        <img class="inline-block h-10 w-10 rounded-full" src="vue/img/<?php echo $info[$i]['avatar'] ?>" alt="" />
                        </div>
                        <div class="ml-3">
                        <p class="text-base leading-6 font-medium text-white">
                            <a href="index.php?action=profile&username= <?php echo $info[$i]['username'] ?>"> <?php echo $info[$i]['name'] ?> </a>
                            <span class="text-sm leading-5 font-medium text-gray-400 group-hover:text-gray-300 transition ease-in-out duration-150">
                            @<?php echo $info[$i]['username'] ?> 
                            </span>
                            </p>
                        </div>
                    </div>
                ...
                <div class="pl-16">
                    ...
                    <?php echo $info[$i]['message']?>
                    </p>
                    <div class="md:flex-shrink pr-6 pt-3">
                    <?php if($info[$i]['url'] != ''){
                            ?>
                    <!-- <img class="rounded-lg w-full h-64" src="img/drift.png" alt="driftpic">-->
                <img class="rounded-lg w-full h-64" src="vue/img/<?php echo  $info[$i]['url']?>" alt="">
                    <?php } ?>
                    </div>
                    <div class="flex">
                        ...
                        <div class="w-full">
                            <div class="flex items-center">
                                <div class="flex-1 text-center">
                                    <a href="index.php?action=reponse&id_tweet= <?php echo $info[$i][0] ?>&name_page=accueil" class="w-12 mt-1 group flex items-center text-gray-500 px-3 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300">
            ...
            <div class="w-2/5 h-12 rightTest">
                ...
                <div class="max-w-sm rounded-lg bg-blue-800 overflow-hidden shadow-lg m-4 mr-20">
                    ...
                    if(isset($user))
                    {
                        ...
                        while($i < $count)
                        {
                            if(!in_array($user[$i]['username'],$tabe)){
                        ?> 
