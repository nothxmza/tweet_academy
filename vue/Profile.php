...
<script>
	$(document).ready(function() {
		...
		const element = document.getElementsByClassName('htg');
        for (let i = 0; i < element.length; i++) {
            const value = element[i].textContent;

            if (value.includes('#')) {
                const valTab = value.trim().split(' ');
                let x = 0;
                while (x < valTab.length) {
                if (valTab[x][0] === '#') {
                    break;
                }
                x++;
                ...
                if (x < valTab.length) {
                    const newHtg = valTab[x].replace(valTab[x], `<a id="htgTweer" href="index.php?action=hashtag&name=${valTab[x].substr(1)}">${valTab[x]}</a>`);
                    const textBefore = valTab.slice(0, x).join(' ');
                    const textAfter = valTab.slice(x+1).join(' ');
                    console.log(textBefore)
                    element[i].innerHTML = `${textBefore} ${newHtg} ${textAfter}`;
                }
            }
        }
        ...
        $('.follow').click(function(){
            ...
            $.ajax({
                ...
                $.each(json, function(key, val){
                    ...
                    let text = document.getElementById('abt').textContent;
                    let ex = document.getElementById('abt');
                    let nbr  = 0;
                    console.log(val);
...
<html>
    <head>
        ...
        <link href="vue/css/profile.css" rel="stylesheet">
    </head>

    <body class="bg-blue-900 h-screen" <?php if ($dark_mode === 'dark') { echo 'style="background-color: black !important; color: white !important;"'; } ?>>
        <div class="flex">
            ...
            <a href="index.php?action=preferences" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300">
            ...
            <?php if($_SESSION['idUser'] == $id_user)
            {
            ...
            <a href="#" class="flex-shrink-0 group block">
                <div class="flex items-center">
                <div>
                    <img class="inline-block h-10 w-10 rounded-full" src="vue/img/<?php echo $userCo['avatar'] ?>" alt="" />
                </div>
                <div class="ml-3">
                    <p class="text-base leading-6 font-medium text-white">
                    <?php echo $userCo['name'] ?>
                    </p>
                    <p class="text-sm leading-5 font-medium text-gray-400 group-hover:text-gray-300 transition ease-in-out duration-150">
                    @<?php echo $userCo['username'] ?>
                    </p>
                </div>
                </div>
            </a>
            ...
            <div class="w-3/5 border border-gray-600 h-auto  border-t-0" >
                ...
                <div class="flex" >
                    <div class="flex-1 m-2">
                        <h2 class="px-4 py-2 text-xl font-semibold text-white">Profil</h2>
                    </div>
                ...
                <!--REDACTION DE TWEET-->
                <div class="flex profil-card" data-user-id="<?php echo $id_user; ?>">
                <div class="relative bg-cover flex justify-center profile-banner">
                    <img class="imgBanner" src="vue/img/<?php echo  $infoUser['banner'] ?>" alt="" >
                    <div class="absolute left-0 m-2 pt-20 profile-picture">
                        <img name="pdp" class="h-40 rounded-full" src="vue/img/<?php echo  $infoUser['avatar'] ?>" alt="" />
                    </div>
                ...
                <!--ICONS REDACTION TWEET-->
                    <div class="flex pt-3">
                        ...
                        <div class="w-64 pt-10">
                            <div class="flex items-stretch text-white mb-3">
                                    <h2 class="font-bold text-white pr-2"><?php echo $infoUser['name']?></h2>
                                    <p class=" text-sm text-gray-400">@<?php echo $infoUser['username']?></p>
                                </div>

                                <div class="flex items-stretch text-white mb-3">
                                    <?php if(isset($infoUser['bio']))
                                    {?>
                                        <p class="text-white pr-2"><?php echo $infoUser['bio']?></p><?php
                                    }?>
                                        
                                    </div>
                                <div class="flex items-stretch mb-3">
                                    <p class="text text-gray-400"><?php echo $infoUser['created_at']?></p></p>
                                </div>
                            <div class="flex items-stretch align-items: stretch text-white mb-3">
                                    <h2 class="font-bold text-white pr-2" id="abt"><?php echo $countFollow[0]?></h2>
                                    <button  data-modal-target="abonnement-modal" data-modal-toggle="abonnement-modal" class="text-sm text-gray-400" >
                                                Abonnements
                                    </button>


                                    <h2 class="font-bold text-white pl-6 pr-2"><?php echo $countFollowing[0]?></h2>
                                        <button  data-modal-target="abonne-modal" data-modal-toggle="abonne-modal" class="text-sm text-gray-400" >
                                        Abonnés
                                        </button>
                                   
                                    <div id="abonnement-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                                        <div class="relative w-full h-full max-w-md md:h-auto">
                                            <!-- Modal content -->
                                            <div class="flex">
                                                <div class="m-2 w-10 py-1">
                                                    ...
                                                    <?php $i = 0;
                                                    $count = count($infoFollow);
                                                    while($i < $count){
                                                    ?><div class="flex flex-shrink-0">
                                                        <div class="flex-1 ">
                                                            <div class="flex items-center w-48">
                                                                <div>
                                                                <img class="inline-block h-10 w-auto rounded-full ml-4 mt-2" src="vue/img/<?php echo $infoFollow[$i]['avatar']?>" alt="" />
                                                                </div>
                                                                <div class="ml-3 mt-3">
                                                                <p class="text-base leading-6 font-medium text-white">
                                                                    <?php echo $infoFollow[$i]['name'] ?>
                                                                </p>
                                                                <p class="text-sm leading-5 font-medium text-gray-400 group-hover:text-gray-300 transition ease-in-out duration-150">
                                                                    <a href="index.php?action=profile&username="<?php echo trim($infoFollow[$i]['username']);?>></a>@<?php echo $infoFollow[$i]['username'] ?>
                                                                </p>
                                                                </div>
                                                            </div>
                                            ...
                                            <div id="abonne-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                                        <div class="relative w-full h-full max-w-md md:h-auto">
                                            <!-- Modal content -->
                                            <div class="flex">
                                                <div class="m-2 w-10 py-1">
                                                    ...
                                                    <?php $i = 0;
                                                    $count = count($infoFollowing);
                                                    while($i < $count){
                                                    ?><div class="flex flex-shrink-0">
                                                        <div class="flex-1 ">
                                                            <div class="flex items-center w-48">
                                                                <div>
                                                                <img class="inline-block h-10 w-auto rounded-full ml-4 mt-2" src="vue/img/<?php echo $infoFollowing[$i]['avatar']?>" alt="" />
                                                                </div>
                                                                <div class="ml-3 mt-3">
                                                                <p class="text-base leading-6 font-medium text-white">
                                                                    <?php echo $infoFollowing[$i]['name'] ?>
                                                                </p>
                                                                <p class="text-sm leading-5 font-medium text-gray-400 group-hover:text-gray-300 transition ease-in-out duration-150">
                                                                    <a href="index.php?action=profile&username="<?php echo trim($infoFollowing[$i]['username']);?>></a>@<?php echo $infoFollowing[$i]['username'] ?>
                                                                </p>
                                                                </div>
                                                            </div>
						...
						<div class="flex-1 text-center ">
                           <a href="index.php?action=edit">
                            <button class="bg-blue-400 mt-5 hover:bg-blue-600 text-white font-bold py-2 px-8 rounded-full mr-8 float-right" name="submit">
                                    Edit
                                </button>
                           </a> 
                        </div>
            ...
            <div>
                ...
                <!--DEUXIEME TWEET-->
			<?php if(isset($infoTweet))
			{
				$count = count($infoTweet);
				$i = 0;
				while($i < $count)
				{
                    if($infoTweet[$i]["parent"] == null){
			?>
            <div class="tweet-card" data-tweet-id="<?php echo $infoTweet[$i][0]; ?>">
                ...
                <div class="pl-16">
                    <p class="text-base width-auto font-medium text-white flex-shrink htg" style="padding: 10px">
                    <?php echo  $infoTweet[$i]['message']?>
                    </p>

                    <div class="md:flex-shrink pr-6 pt-3">
                    <?php if($infoTweet[$i]['url'] != ''){
                            ?>
                    <!-- <img class="rounded-lg w-full h-64" src="img/drift.png" alt="driftpic">-->
                <img class="rounded-lg w-full h-64" src="vue/img/<?php echo  $infoTweet[$i]['url']?>" alt="">
                    ...
                    <div class="flex">
                        ...
                        <div class="w-full">
                            <div class="flex items-center">
                                <div class="flex-1 text-center">
                                    <a href="index.php?action=reponse&id_tweet= <?php echo $infoTweet[$i][0] ?>&name_page=accueil" class="w-12 mt-1 group flex items-center text-gray-500 px-3 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300">
                        ...
                        <div class="flex flex-shrink-0 card-User" data-id-follow="<?php echo $user[$i][0];?>" data-id-home="<?php echo $_SESSION['idUser'] ?>" data-id-profile="<?php echo $id_user ?>">
                            <div class="flex-1 ">
                                <div class="flex items-center w-48">
                                    ...
                                    <div class="ml-3 mt-3">
                                        <p class="text-base leading-6 font-medium text-white">
                                        <a href="index.php?action=profile&username=<?php echo $user[$i]['username'] ?>" ><?php echo $user[$i]['name'] ?> </a>
                                        </p>
                                        <p class="text-sm leading-5 font-medium text-gray-400 group-hover:text-gray-300 transition ease-in-out duration-150">
